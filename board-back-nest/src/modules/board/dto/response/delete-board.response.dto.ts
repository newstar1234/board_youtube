...
export default class DeleteBoardResponseDto extends ResponseDto {
  ...
  static noPermission() {
    throw new ForbiddenException(new ResponseDto(ResponseCode.NO_PERMISSIOM, ResponseMessage.NO_PERMISSIOM));
  }
