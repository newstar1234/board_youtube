...
export default function Authentication() {
  ...
  const SignUpCard = () => {
    ...
    // state : 개인정보동의 에러 상태 //
    const [isAgreedPersonalError, setAgreedPresonalError] = useState<boolean>(false);
    ...
    const onSignUpButtonClickHandler = () => {
      ...
      if(!agreedPersonal) setAgreedPresonalError(true);
